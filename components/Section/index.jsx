    ...
    return (
        <div className='bg-theme'>
            <div className="container flex flex-col mx-auto">
                <section className={`${containerClassName} group w-full flex flex-col lg:flex-row justify-between border border-[#333333] hover:bg-[#121212] hover:border-[#4e4e4e] rounded-sm transition-all gap-30 py-46 md:py-64 px-20 md:px-40 mb-20`}>
